...
def get_args():
    parser = argparse.ArgumentParser('Photomosaic')
    parser.add_argument('--input', type=str, default='input/input.jpg', help='Path to input image')
    parser.add_argument('--output', type=str, default='output/output.jpg', help='Path to output image')
